//! `BitTorrent` compatibility actor and rarest-first scheduling adapter.
//!
...
//!
//! This module exists only as a real-world reference workload. It does not define
//! generic orchestration, resource admission, retry, task ownership, or telemetry.
use std::{
    cmp::Ordering,
